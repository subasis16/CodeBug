      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-ossium-muted text-lg">Essential resources for your daily workflow.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {categories.map((category) => (
            <Link
              key={category.id}
              to={category.path}
              className="group relative p-8 bg-[#0f0f0f] rounded-xl border border-white/5 hover:border-ossium-accent/30 transition-all duration-300 hover:-translate-y-1"
            >
              <div className="flex flex-col h-full justify-between">
                <div>
                  <div className="text-ossium-accent mb-6 text-3xl group-hover:scale-110 transition-transform duration-300 origin-left">
                    {category.icon}
                  </div>
                  <h3 className="text-xl font-bold text-white mb-2 group-hover:text-ossium-accent transition-colors">
                    {category.name}
                  </h3>
                ...
                <div className="mt-8 flex items-center gap-2 text-sm font-medium text-white group-hover:text-ossium-accent transition-colors">
                  Explore
